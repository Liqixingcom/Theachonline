...
public interface PermissionService extends IService<Permission> {
    ...
    List<Permission> queryAllMenuGulilqx();

    Integer removeChildByIdGulilqx(String id);

    boolean saveRolePermissionRealtionShipGulilqx(String roleId, String[] permissionId);
}
